...
namespace SigmaERP.All_Report.Attendance {
    ...
    public class AttTodaysStatusM : ReportClass {
        
        public AttTodaysStatusM() {
        }
        
        public override string ResourceName {
            get {
                return "AttTodaysStatusM.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SigmaERP.All Report.Attendance.AttTodaysStatusM.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedAttTodaysStatusM : Component, ICachedReport {
        
        public CachedAttTodaysStatusM() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AttTodaysStatusM rpt = new AttTodaysStatusM();
            rpt.Site = this.Site;
            return rpt;
        }
