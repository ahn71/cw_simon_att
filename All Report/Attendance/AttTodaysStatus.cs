...
namespace SigmaERP.All_Report.Attendance {
    ...
    public class AttTodaysStatus : ReportClass {
        
        public AttTodaysStatus() {
        }
        
        public override string ResourceName {
            get {
                return "AttTodaysStatus.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SigmaERP.All Report.Attendance.AttTodaysStatus.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedAttTodaysStatus : Component, ICachedReport {
        
        public CachedAttTodaysStatus() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AttTodaysStatus rpt = new AttTodaysStatus();
            rpt.Site = this.Site;
            return rpt;
        }
