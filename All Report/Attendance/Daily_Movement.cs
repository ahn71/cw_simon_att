...
namespace SigmaERP.All_Report.Attendance {
    ...
    public class Daily_Movement : ReportClass {
        
        public Daily_Movement() {
        }
        
        public override string ResourceName {
            get {
                return "Daily_Movement.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SigmaERP.All Report.Attendance.Daily_Movement.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedDaily_Movement : Component, ICachedReport {
        
        public CachedDaily_Movement() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Daily_Movement rpt = new Daily_Movement();
            rpt.Site = this.Site;
            return rpt;
        }
