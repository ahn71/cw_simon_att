...
namespace SigmaERP.All_Report.PF {
    using System;
    ...
    public class MonthlyPFSheet : ReportClass {
        
        public MonthlyPFSheet() {
        }
        
        public override string ResourceName {
            get {
                return "MonthlyPFSheet.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SigmaERP.All Report.PF.MonthlyPFSheet.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedMonthlyPFSheet : Component, ICachedReport {
        
        public CachedMonthlyPFSheet() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            MonthlyPFSheet rpt = new MonthlyPFSheet();
            rpt.Site = this.Site;
            return rpt;
        }
