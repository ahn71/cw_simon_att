...
namespace SigmaERP.All_Report.Personnel {
    ...
    public class SalaryBankOrCash : ReportClass {
        
        public SalaryBankOrCash() {
        }
        
        public override string ResourceName {
            get {
                return "SalaryBankOrCash.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SigmaERP.All Report.Personnel.SalaryBankOrCash.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSalaryBankOrCash : Component, ICachedReport {
        
        public CachedSalaryBankOrCash() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SalaryBankOrCash rpt = new SalaryBankOrCash();
            rpt.Site = this.Site;
            return rpt;
        }
