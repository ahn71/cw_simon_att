<%@ Page Title="Earned Leave" Language="C#" MasterPageFile="~/leave_nested.master" AutoEventWireup="true" CodeBehind="earn_leave.aspx.cs" Inherits="SigmaERP.leave.earn_leave" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    Text="*" ErrorMessage="ErrorMessage"></asp:RequiredFieldValidator>
                            ...
                            <td>
                                <asp:Label ID="lblTitle" runat="server">Company</asp:Label>
                                &nbsp;</td>
                            <td> 
                                
                                <asp:DropDownList ID="ddlCompany" runat="server" AppendDataBoundItems="True" AutoPostBack="true" ClientIDMode="Static" CssClass="form-control select_width" OnSelectedIndexChanged="ddlCompany_SelectedIndexChanged" >
                                </asp:DropDownList>
                            </td>
