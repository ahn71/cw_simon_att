<%@ Page Title="Job Card" Language="C#" MasterPageFile="~/Glory.Master" AutoEventWireup="true" CodeBehind="job_card_with_summary.aspx.cs" Inherits="SigmaERP.attendance.job_card_with_summary" %>
        ...
        <div class="col-md-12">
            <div class="ds_nagevation_bar">
                <ul>
                    ...
                    <li>/</li>
                    <li><a href="#" class="ds_negevation_inactive Mactive">Job Card</a></li>
                </ul>
            </div>
        </div>
    </div>
