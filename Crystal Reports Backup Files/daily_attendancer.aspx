<%@ Page Title="Daily Attendancer" Language="C#" MasterPageFile="~/Glory.Master" AutoEventWireup="true" CodeBehind="daily_attendancer.aspx.cs" Inherits="SigmaERP.attendance.daily_attendancer" %>
        ...
        <div class="main_box_body">
            <div class="main_box_content">
                ...
                <div class="daily_absence_report_box3">
                    <p>
                        Division Name : 
                       <asp:DropDownList ID="ddlDivision" ClientIDMode="Static" AppendDataBoundItems="True" CssClass="form-control select_width" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="ddlDivision_SelectedIndexChanged"></asp:DropDownList>
                    </p>
                </div>
                ...
                <div class="job_card_button_area">
                    <%--<button class="css_btn" type="button" name="" value="">Preview</button>--%>
                            <asp:Button ID="btnPreview" CssClass="css_btn" style="display:none"  ValidationGroup="save" runat="server" Text="Preview" />
                             ...
                             <asp:Button ID="btnPreviewAtt" CssClass="css_btn" ValidationGroup="save" runat="server" Text="Preview" OnClick="btnPreviewAtt_Click" />
                              &nbsp; &nbsp; &nbsp;
