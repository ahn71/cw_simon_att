<%@ Page Title="Late Report" Language="C#" MasterPageFile="~/Glory.Master" AutoEventWireup="true" CodeBehind="late_report.aspx.cs" Inherits="SigmaERP.attendance.late_report" %>
        ...
        <div class="main_box_body">
            <div class="main_box_content">
                ...
                <div class="daily_absence_report_box3">
                    <p>
                        Division Name : 
                       <asp:DropDownList ID="ddlDivision" ClientIDMode="Static" AppendDataBoundItems="True" CssClass="form-control select_width" runat="server"  AutoPostBack="true" OnSelectedIndexChanged="ddlDivision_SelectedIndexChanged">
                       </asp:DropDownList>
                    </p>
                </div>
                ...
                <div class="job_card_button_area">
                    <%--<button class="css_btn" type="button" name="" value="">Preview</button>--%>
                            <asp:Button ID="btnPreview" CssClass="css_btn" style="display:none"  ValidationGroup="save" runat="server" Text="Preview" />
                             ...
                             <asp:Button ID="btnPreviewLate" CssClass="css_btn" ClientIDMode="Static" ValidationGroup="save" runat="server" Text="Preview" OnClick="btnPreviewLate_Click" />
                              &nbsp; &nbsp; &nbsp;
