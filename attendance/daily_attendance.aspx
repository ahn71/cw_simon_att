<%@ Page Title="Daily Absence Report" Language="C#" MasterPageFile="~/attendance_nested.Master" AutoEventWireup="true" CodeBehind="daily_attendance.aspx.cs" Inherits="SigmaERP.attendance.daily_attendance" %>
            ...
            <div class="main_box_content">
                ...
                <div class="daily_absence_report_box2">
                    <table class="table_daily_absence_report">
                        <tr>
                            ...
                            <td>
                                <asp:RadioButtonList ID="rdoDept" runat="server" RepeatDirection="Horizontal">
                ...
                <div class="daily_absence_report_box4">
                    <div class="daily_absence_report_left">
                        ...
                        <asp:ListBox ID="lstEmployees" Width="260" Height="146" runat="server" SelectionMode="Multiple"></asp:ListBox>
                    </div>
                    <div class="daily_absence_report_middle">

                        <asp:Button ID="btnadditem" CssClass="next_button" runat="server" Text=">" OnClick="btnadditem_Click1" />
                        <br />
                ...
                <div class="job_card_button_area">
                    ...
                    <asp:Button ID="btnPreview" CssClass="css_btn"  ValidationGroup="save" runat="server" Text="Preview" OnClick="btnPreview_Click1"/>
                    &nbsp; &nbsp; &nbsp;
