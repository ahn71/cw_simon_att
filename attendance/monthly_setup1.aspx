<%@ Page Title="" Language="C#" MasterPageFile="~/attendance_nested.master" AutoEventWireup="true" CodeBehind="monthly_setup1.aspx.cs" Inherits="SigmaERP.attendance.monthly_setup1" %>
                            ...
                            <table class="input_division_info">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtTotalHoliday" ClientIDMode="Static" runat="server" CssClass="form-control text_box_width" Enabled="false"></asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:TextBox ID="txtTotalWorkingDays" ClientIDMode="Static" runat="server" CssClass="form-control text_box_width" Enabled="false"></asp:TextBox>
