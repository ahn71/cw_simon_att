<%@ Page Title="Company Information" Language="C#" MasterPageFile="~/Glory.Master" AutoEventWireup="true" CodeBehind="new_company.aspx.cs" Inherits="SigmaERP.tools.new_company" %>
    	...
    	<div class="main_box_body">
        	<div class="main_box_content">
                ...
                <div class="late_report_button">
                    <button class="css_btn" type="submit" name="" value="">Install</button> &nbsp; &nbsp;
