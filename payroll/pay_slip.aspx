<%@ Page Title="Pay Slip" Language="C#" MasterPageFile="~/payroll_nested.master" AutoEventWireup="true" CodeBehind="pay_slip.aspx.cs" Inherits="SigmaERP.payroll.pay_slip1" %>
   ...
   <div class="row">
        <div class="col-md-12">
            <div class="ds_nagevation_bar">
                <ul>
                    ...
                    <li><a class="seperator" href="#">/</a></li>
                    <li><a href="#" class="ds_negevation_inactive Pactive">Pay Slip Report</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(document).keyup(function (e) {
            if (e.keyCode == 80) {
                goToNewTabandWindow('/payroll/pay_slip2.aspx');
            }
        });
