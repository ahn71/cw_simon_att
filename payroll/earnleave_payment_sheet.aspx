<%@ Page Title="Earnleave Payment Sheet" Language="C#" MasterPageFile="~/payroll_nested.master" AutoEventWireup="true" CodeBehind="earnleave_payment_sheet.aspx.cs" Inherits="SigmaERP.payroll.earnleave_payment_sheet" %>
     ...
     <asp:UpdatePanel ID="uplMessage" runat="server">
       ...
       <div class="main_box Mbox">
        <div class="main_box_header PBoxheader">
            <h2>Earnleave Payment Sheet (Actual)</h2>
        </div>
