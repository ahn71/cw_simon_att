<%@ Page Title="Holiday Generation" Language="C#" MasterPageFile="~/payroll_nested.Master" AutoEventWireup="true" CodeBehind="holiday_generation.aspx.cs" Inherits="SigmaERP.payroll.holiday_generation" %>
        	...
        	<div class="main_box_content">
                ...
                <div class="bonus_generation">
                     <table  class="bonus_generation_table">
                       <%--  <a href="holiday_generation.aspx">holiday_generation.aspx</a>--%>
                            <tr>
                                <td>
                                    Select Date</td>
                                <td>
                                    <asp:TextBox CssClass="form-control text_box_width" ID="txtGenerateMonth" runat="server" ClientIDMode="Static"></asp:TextBox>
                                    <asp:CalendarExtender ID="txtGenerateMonth_CalendarExtender" Format="yyyy-MM-dd" runat="server" TargetControlID="txtGenerateMonth">
                ...
                <div class="payroll_generation_button">
                    ...
                    <asp:Button ID="btnGeneration" runat="server" CssClass="css_btn" Text="Generation" OnClientClick="return InputValidationBasket();" OnClick="btnGeneration_Click"  />
