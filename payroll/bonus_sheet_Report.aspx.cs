    ...
    public partial class bonus_sheet_Report : System.Web.UI.Page
    {
        ...
        private void generateBonusSheet()
        {
            try
            {
                ...
                if (rblGenerateType.SelectedItem.Text.Equals("All"))
                {
                    getSQLCMD = "SELECT GId,Gname,EmpType, substring(v_Payroll_YearlyBonusSheet.EmpCardNo,8,15)+'('+EmpProximityNo+')' as EmpCardNo, v_Payroll_YearlyBonusSheet.PresentSalary,v_Payroll_YearlyBonusSheet.BasicSalary,v_Payroll_YearlyBonusSheet.BonusAmount," +
