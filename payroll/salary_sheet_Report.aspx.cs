...
{
    public partial class salary_sheet_Report : System.Web.UI.Page
    {
        ...
        private void setPrivilege()
        {
            try
            {
                ...
                classes.Payroll.loadMonthIdByCompany1(ddlSelectMonth, ViewState["__CompanyId__"].ToString());
                //-----------------------------------------------------
        ...
        private void generateSalarySheet()
        {
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "call me", "goToNewTabandWindow('/All Report/Report.aspx?for=SalarySheet-" + ddlSelectMonth.SelectedItem.Text.Replace('-','/') + "-" + ViewState["__IsGerments__"].ToString() + "-" + rblEmployeeType.SelectedValue + "-" + rblPaymentType.SelectedValue + "-0');", true);  //Open New Tab for Sever side code
            }
            catch { }
        }
        ...
        protected void ddlCompanyName_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //addAllTextInShift();
                classes.Payroll.loadMonthIdByCompany1(ddlSelectMonth, CompanyId);
            }
            catch { }
        }
