<%@ Page Title="" Language="C#" MasterPageFile="~/Glory.Master" AutoEventWireup="true" CodeBehind="LeaveApplicationReport.aspx.cs" Inherits="SigmaERP.personnel.LeaveApplicationReport" %>
...
<asp:UpdatePanel ID="uplMessage" runat="server" >
    ...
    <div class="worker_id__main_box">
        <div class="punishment_box_header">
            <h2>Maternity Leave Application</h2>
        </div>
                    ...
                    <table class="emp_button_table">
                        <tbody>
                            <tr>
                                ...
                                <th><asp:Button ID="btnClose" CssClass="css_btn" Text="Close" PostBackUrl="~/leave_default.aspx" runat="server" /></th> 
                         </tr>
                    </tbody>
                  </table>
                </div>
