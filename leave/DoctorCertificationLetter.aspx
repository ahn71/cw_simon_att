<%@ Page Title="" Language="C#" MasterPageFile="~/leave_nested.Master" AutoEventWireup="true" CodeBehind="DoctorCertificationLetter.aspx.cs" Inherits="SigmaERP.personnel.DoctorCertificationLetter" %>
...
<asp:UpdatePanel ID="uplMessage" runat="server" >
    ...
    <div class="worker_id__main_box">
        <div class="punishment_box_header">
            <h2>Maternity Doctor Certification Letter</h2>
        </div>
